This is the frontend to sustainindyfoods.com; it pairs with [the backend code, also open source](https://github.com/mikeyk/saveourfaves-server), so please read the README there as well.
